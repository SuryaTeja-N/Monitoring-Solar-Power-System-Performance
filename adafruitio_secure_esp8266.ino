...
#define WLAN_SSID       "surya teja neerukattu"
#define WLAN_PASS       "suryateja"

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  8883                   // 8883 for MQTTS
#define AIO_USERNAME    "suryateja123"
#define AIO_KEY         "aio_VRjc65xu3Ua86YLqC9kymuJqwuek"
...
Adafruit_MQTT_Publish test = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/Voltage");
...
void loop() {
  ...
  int Volt_value = analogRead(sensor);
  if (! test.publish(Volt_value)) {
